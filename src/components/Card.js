...
<text fill="white" xml:space="preserve" style="white-space: pre" font-family="Poppins" font-size="10" font-weight="600" letter-spacing="0px"><tspan x="26" y="30.5">${category}</tspan></text>
<text fill="black" xml:space="preserve" style="white-space: pre" font-family="Poppins" font-size="14" font-weight="600" letter-spacing="0px"><tspan x="16.5" y="60.9">${name}</tspan></text>
<text fill="#666666" xml:space="preserve" style="white-space: pre" font-family="Poppins" font-size="12" letter-spacing="0px"><tspan x="16.5" y="83.7">${cnpj}</tspan></text>
<text><tspan x="16.5" y="83.7">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</tspan></text>
</svg>
`
}
